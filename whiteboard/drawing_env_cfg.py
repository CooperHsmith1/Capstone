...
def make_drawing_env_cfg(
  ...
  actor_terms = {
    ...
    "pen_pos": (
      ...
      if filtered
      else ObservationTermCfg(func=site_position, params={"asset_cfg": _PEN_TIP_CFG})
    ),
  ...
  actions: dict[str, ActionTermCfg] = {
    "joint_pos": JointPositionActionCfg(
      ...
      # Give the policy the full useful arm range instead of making the
      # wrist appear locked near its reset pose.
      scale=0.75,
  ...
  rewards = {
    ...
    "pen_approach": RewardTermCfg(
      func=pen_approach_reward,
      weight=4.0,
      params={"writing_x": WRITING_X, "asset_cfg": _PEN_TIP_CFG},
    ),
    "pen_contact": RewardTermCfg(
      func=pen_contact_reward,
      weight=2.0,
      params={
        "whiteboard_x": BOARD_FACE_X,
        "writing_x": WRITING_X,
