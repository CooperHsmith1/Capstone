...
MJCF reference (g1_29dof_whiteboard.xml)::
    ...
    body pos   = (0.65, 0, 1.10)
    geom size  = (0.02, 0.40, 0.35)      half-extents in (x, y, z)

so the writable face is at x = 0.65 - 0.02 = 0.63, and the physical surface
...
BOARD_FACE_X: float = BOARD_CENTRE_X - BOARD_HALF_DEPTH  # 0.63
